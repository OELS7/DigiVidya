                                ...
                                IconButton(
                                    onPressed: () async {
                                      ...
                                      File TopicImage = File(
                                          "${await getDirectory().getdirectory()}/Section${sectionID}/Topic${topic_id}/topic${topic_id}.png");
                                      ...
                                      if (!TopicImage.existsSync()) {
                                        ...
                                        _screenshotController
                                            .capture()
                                            .then((value) async {
                                          TopicImage.createSync(
                                              recursive: true);
                                          await TopicImage.writeAsBytes(value!)
                                              .then((value) {
                                            ShareTopic(TopicImage.path,
                                                uri.toString());
                                          });
                                        });
                                      }
  ...
  getUpdatedAudioFile() async {
    ...
    for (int tAudioTrack = 0; tAudioTrack < topicCount; tAudioTrack++) {
      ...
      File topicAudioFile = File(
          "$directory/DigiVidya/Section_${section_Id + 1}/AudioFile/Topic_${tAudioTrack + 1}/${listFileNameFromServer[tAudioTrack]}.mp3");
      ...
      if (!topicAudioFile.existsSync()) {
        ...
        Directory("$directory/DigiVidya/Section_${section_Id + 1}/AudioFile/")
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (jsonResponse.isNotEmpty) {
            ...
            //List<dynamic> completedId = jsonResponse['completedIDs'];
...
// Function to share topic
  ...
  _getScreenSize(double width) {
    ...
    if (width <= 425 && width > 375) {
      ...
      debugPrint("%%%%%%%%%%% For Large Screen Size Like Redmi  ${height },${ width} %%%%%%%%%%%%%%");
    }
