                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                          ...
                          onTap: () {
                            Navigator.of(context)
                                .pushReplacement(MaterialPageRoute(
                                    builder: ((context) =>vediopage(userName: userName,mobilenumber: mobilenumber,language: 'Marathi',city:city ,device_id: deviceId,)),
                                    // settings: RouteSettings(arguments: {
                                    //   'language': 'hindi',
                                    //   'userName': userName,
                                    //   'mobilenumber': mobilenumber,
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                          ...
                          onTap: () {
                            Navigator.of(context)
                                .pushReplacement(MaterialPageRoute(
                                    builder: ((context) =>vediopage(userName: userName,mobilenumber: mobilenumber,language: 'Hindi',city:city ,device_id: deviceId,)),
                                    // settings: RouteSettings(arguments: {
                                    //   'language': 'hindi',
                                    //   'userName': userName,
                                    //   'mobilenumber': mobilenumber,
