...
// Variables for tracking section and topics
  ...
  void _onAdloaded(InterstitialAd ad) {
    ...
    _interstitialAd.fullScreenContentCallback = FullScreenContentCallback(
      onAdDismissedFullScreenContent: (ad) {
        ...
        Future.delayed(
          Duration(milliseconds: 100), // Delay to show the ad
          () {
      ...
      body: Container(
          ...
          child: Column(
            ...
            onTap: () async {
              ...
              File jsonFile =
                  File("$dir/appInfo.json"); // Create a file instance
            ...
            child: Container(
              height: MediaQuery.of(context).size.height *
                  0.06, // Set button height
              width:
                  MediaQuery.of(context).size.width * 0.5, // Set button width
              decoration: BoxDecoration(
  ...
  _loadPreferedInviteImage() async {
    ...
    String userPrefredLanguage = "";
    // Get the path of the application support directory

    String dir = await getDirectory().getdirectory();

    File jsonFile = File(
        "$dir/appInfo.json"); // Create a File object for the JSON file containing user preferences
    var JsonData = jsonDecode(jsonFile
    ...
    switch (userPrefredLanguage.toLowerCase().toString()) {
      case "marathi":
        setState(() {
          ...
          inviteImage = 'assets/images/Invite_bg_image.jpg';
          ButtonText = "मित्रांना मदत करा";
          Description =
